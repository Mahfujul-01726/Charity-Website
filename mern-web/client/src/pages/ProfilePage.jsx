...
export default function ProfilePage() {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            setUser(updatedUser); // Update context instantly
            setIsEditing(false);
            ...
            <article className="glass-card" style={{ marginBottom: "20px" }}>
                ...
                {isEditing ? (
                    <form className="form-grid" onSubmit={handleSave} style={{ marginTop: "1rem" }}>
                        <label>
                            ...
                            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                                {form.avatarUrl && (
                                    <img src={form.avatarUrl} alt="Avatar" style={{ width: 60, height: 60, borderRadius: "50%", objectFit: "cover" }} />
                                )}
                    ...
                    <div style={{ marginTop: "1rem" }}>
                        {form.avatarUrl && (
                            <img src={form.avatarUrl} alt="Avatar" style={{ width: 80, height: 80, borderRadius: "50%", objectFit: "cover", marginBottom: "10px" }} />
                        )}
